  ...
  <div class="product-modal" v-if="show">
    <div class="product-modal__wrap">
      ...
      <div class="product-modal__intro">
        <div class="product-modal__cat">{{ category }}</div>
        <div class="product-modal__title">{{ product.name }}</div>

        <span class="product-modal__pr">
          <span class="product-modal__item__tags">
        ...
        <ul class="product-modal__ingredient-remove">
          <li>
            <label>
              <input type="checkbox" name="ingredient-1" value="" />Сыр
              моцарелла
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-2" value="" />Бекон
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-3" value="" />Сухарики
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-4" value="" />Яйцо
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-5" value="" />Салат
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-6" value="" />Тыква
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-7" value="" />Нут
            </label>
          </li>
          <li>
            <label>
              <input type="checkbox" name="ingredient-8" value="" />Лук
            </label>
          </li>
        </ul>
        ...
        <ul class="product-modal__supplement">
          ...
          <li>
            <label>
              <img src="img/champignon.png" alt="" />
              <input type="checkbox" name="ingredient-2" value="" />
              <span>шампиньон</span>
              <span>+ 29 ₽</span>
            </label>
